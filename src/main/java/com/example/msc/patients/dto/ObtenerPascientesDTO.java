...
public class ObtenerPascientesDTO implements Serializable {
    ...
    public ObtenerPascientesDTO(@NotNull int id, String primerNombre, String ultimoNombre, @NotNull Date fechaIngreso, @NotNull Date fechaNacimiento, @NotNull double peso, String numeroDocumento, List<Contacto> contacto) {
        this.id = id;
